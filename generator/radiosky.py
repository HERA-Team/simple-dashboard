...
def get_map():
    ...
    pic = astropy.coordinates.SkyCoord(ra = '05h 19m 49.7230919028', dec = '-45d 46m 44s') #Pictor
    ...
    healpy.orthview(np.log10(mappy), coord = ['G', 'C'], rot = rot, return_projected_map = True, max = 2, half_sky = 1)
