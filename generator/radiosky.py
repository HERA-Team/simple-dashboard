...
def get_map():
    ...
    healpy.orthview(np.log10(mappy), title = sidstr, coord = ['G', 'C'], rot = rot, return_projected_map = True, min = 0, max = 2, half_sky = 1)
...
get_map()
plt.savefig('radiosky.png', bbox_inches='tight', pad_inches = .2)
