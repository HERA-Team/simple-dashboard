...
class Emitter(object):
    ...
    def prep_data(self):
        ...
        keys = [k for k in redis.keys()
                if k.startswith('visdata' and not k.endswith('timestamp'))]
        ...
        ys = np.ma.masked_array([antpos[1, ant_index] + 3 * (poli[pol] -.5) for pol in pols] , mask=_amps.mask)
        ...
        self.emit_js(',\ntext :', end='')
        self.emit_data_array(name_offline, '{}')
        self.emit_js(",\nmode : 'markers'", end='')
        ...
        self.emit_js(",\nmode: markers'", end='')
        self.emit_js(",\ntext:", end='')
        self.emit_data_array(_text[0].compressed(), '{}')
        ...
        self.emit_js(",\nmode: markers'", end='')
        self.emit_js(",\ntext:", end='')
        self.emit_data_array(_text[1].compressed(), '{}')
        self.emit_js(',\nmarker: {  color:', end='')
        ...
        self.emit_js(",\ntext:", end='')
        self.emit_data_array(_text[0][_text[0].mask], '{}')
        self.emit_js(",\nmode: markers'", end='')
